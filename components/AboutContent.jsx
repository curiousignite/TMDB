            ...
            <section id="about" className="py-6 border-top border-bottom rounded">
                <div className="row">
                    ...
                    <div className="col my-auto">
                        ...
                        <p className="pr-20">This is a front-end project for job application to Appcent which developped by Berke Erbağcı. HTML5, CSS Bootstrap and React/Next.js are the used front-end technologies. </p>
